...
const ghostInfos = [
    ...
    { name: "dayan", evidences: [1, 2, 4], description: "The Dayan gains strength to protect itself if people \'dance\' too close to it. <span class='weakness'>The Dayan loses strength if people close to her stand still.</span>", hunt_threshold: "?", unique: "???" },
    ...
    { name: "obambo", evidences: [3, 5, 7], description: "Whie aggressive, the Obambo is quicker to start hunting. <span class='weakness'>While calm, the Obambo is slower to start hunting and easier to track.</span>", hunt_threshold: "?", unique: "???" }
];
...
const last_updated = "12/16/25"
const phasmophobia_server_version = "0.15.1.0"
