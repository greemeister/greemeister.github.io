...
const ghostInfos = [
    ...
    { name: "dayan", evidences: [1, 2, 4], description: "The Dayan gains strength to protect itself if people \'dance\' too close to it. <span class='weakness'>The Dayan loses strength if people close to it stand still.</span>", hunt_threshold: "?", unique: "???" },
